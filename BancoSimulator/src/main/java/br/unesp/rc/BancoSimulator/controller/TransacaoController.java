...
import br.unesp.rc.BancoSimulator.service.TransacaoService;
...
public class TransacaoController {
    ...
    public ResponseEntity<?> save(@RequestBody Transacao transacao) {
        try {
            Transacao newTransacao = transacaoService.save(transacao);
    ...
    public ResponseEntity<?> update(@RequestBody Transacao transacao) {
        try {
            Transacao updatedTransacao = transacaoService.update(transacao);
